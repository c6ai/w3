...
using vSPACE.Helpers;
using vSPACE.Models;

namespace vSPACE.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> PresentationRequest()
        {
            ...
            try
            {
                ...
                vSPACE.Models.PresentationRequest request = CreatePresentationRequest( null, null );
        ...
        public vSPACE.Models.PresentationRequest CreatePresentationRequest( string stateId = null, string credentialType = null ) {
            vSPACE.Models.PresentationRequest request = new vSPACE.Models.PresentationRequest() {
                ...
                registration = new Registration() {
                    clientName = _configuration.GetValue("VerifiedID:client_name", "vSPACE"),
            ...
            if (string.IsNullOrEmpty( credentialType )) {
                credentialType = _configuration.GetValue("VerifiedID:CredentialType", "VerifiedCredential");
            }
        ...
        public vSPACE.Models.PresentationRequest AddRequestedCredential( vSPACE.Models.PresentationRequest request
            ...
            request.requestedCredentials.Add( new RequestedCredential() {
                ...
                configuration = new vSPACE.Models.Configuration() {
        ...
        public bool IsFaceCheckRequested( vSPACE.Models.PresentationRequest request ) {
        ...
        public async Task<ActionResult> ProcessPresentedCredentials( string id ) {
            try {
                ...
                string credentialType = _configuration.GetValue("VerifiedID:CredentialType", "VerifiedCredential" );
